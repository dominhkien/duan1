                ...
                <div class="account-area">
                    ...
                    <form class="account-form" action="index.php?act=sign-up" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="email" placeholder="Enter Your Email" id="email1" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="confirm-pass" placeholder="Password" id="pass2" required>
                        </div>
