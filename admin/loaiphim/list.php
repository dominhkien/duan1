                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-outline-success"><a
                                            onclick="return confirm('Xoá là mất luôn ??')" style="color: #000000;"
                                            href="<?= $xoatheloai ?>">Xoá</a></button> |
                                    <button type="button" class="btn btn-outline-success"><a style="color: #000000;"
